        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('/report/pre_order') ?>" method="post" class="row g-3">
                                <div class="col-md-5">
                    ...
                    <?php else : ?>
                        <div class="d-flex justify-content-end mb-4">
                            ...
                            <a href="<?= base_url('report/downloadPDFReportPreorder/' . $startdate . '/' . $enddate) ?>" class="btn btn-danger ms-2 ml-2">Download PDF</a>
                            <a href="<?= base_url('report/downloadExcelReportPreorder/' . $startdate . '/' . $enddate) ?>" class="btn btn-primary ms-2 ml-2">Download Excel</a>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($reports as $report) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="/report/preOrderdetail/<?= $report['id']; ?>" class="btn btn-info btn-sm">Detail</a></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
