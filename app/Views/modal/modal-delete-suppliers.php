...
<div class="modal fade" id="delete-suppliers" tabindex="-1" role="dialog" aria-labelledby="deleteModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="DeleteSuppliersForm" method="POST">
                    <input type="hidden" id="deleteSupplierId" name="id_suppliers">
                    <?= csrf_field() ?>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.delete-button', function() {
            ...
            $('#delete-suppliers').modal('show');
        });

        // Handle Form Submission untuk Hapus Supplier
        $('#DeleteSuppliersForm').on('submit', function(e) {
            e.preventDefault();
            const id = $('#deleteSupplierId').val();
            $.ajax({
                url: '<?= site_url('admin/suppliers/delete') ?>',
                type: 'POST',
                data: $(this).serialize(),
                dataType: 'json',
